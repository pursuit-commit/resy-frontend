      ...
      <Container id="container" maxWidth="lg" sx={{ 'paddingBottom': '100px' }}>
        {data && data.restaurant && (
          <>
            ...
            {data.restaurant.reservations && <ReservationList reservations={data.restaurant.reservations} />}
            ...
            {showReservationForm && <NewReservation restaurantId={data.restaurant.id} />}
          </>
        )}
      </Container>
    </QueryResult>
